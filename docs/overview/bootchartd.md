...
Pantavisor supports [bootchartd](https://github.com/mmeeks/bootchart) for boot time profiling. When enabled, Pantavisor generates a `/bootlog.tgz` tarball capturing the boot sequence.

...
PV_PVTEST_CONTAINERS_XCONNECT ?= "pv-example-system-dbus-server pv-example-system-dbus-server-collision pv-example-system-dbus-client pv-example-system-dbus-client-denied pv-example-system-dbus-names-orphan pv-example-system-dbus-client-onowner pv-example-system-dbus-reader pv-avahi pv-avahi-browse pv-example-system-dbus-limited pv-example-system-dbus-badpolicy-include pv-example-system-dbus-badpolicy-foreign pv-example-system-dbus-badpolicy-role pv-example-system-dbus-badpin"

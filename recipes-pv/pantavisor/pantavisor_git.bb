...
SRCREV = "5f8c89cdbdea9cbca17dd885b4391ce80df0a8fe"
PE = "1"
...
EXTRA_OECMAKE += "${@bb.utils.contains('PANTAVISOR_FEATURES', 'wasmedge', '-DPANTAVISOR_WASMEDGE_ENABLE=ON', '-DPANTAVISOR_WASMEDGE_ENABLE=OFF', d)}"

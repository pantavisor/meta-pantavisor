...
SRCREV = "9bc15a32ffdebb73487b124ff315405aa9c30faa"
PE = "1"
...
EXTRA_OECMAKE += "${@bb.utils.contains('PANTAVISOR_FEATURES', 'appengine', '-DPANTAVISOR_PVS_SKIP_INSTALL=OFF -DPANTAVISOR_DEFAULTS_SKIP_INSTALL=OFF', '-DPANTAVISOR_PVS_SKIP_INSTALL=ON -DPANTAVISOR_DEFAULTS_SKIP_INSTALL=ON', d)}"

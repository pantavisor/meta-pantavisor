SUMMARY = "Example hosted-bus D-Bus consumer restricted by a raw policy fragment (avahi-limited role, GetHostName denied)"
LICENSE = "MIT"
LIC_FILES_CHKSUM = "file://${COMMON_LICENSE_DIR}/MIT;md5=0835ade698e0bcf8506ecda2f7b4f302"

inherit core-image container-pvrexport

IMAGE_BASENAME = "pv-example-system-dbus-limited"

PVRIMAGE_AUTO_MDEV = "0"

# Single-pid consumer: no dbus-daemon, just the client tools to dial the bus
# socket that pantavisor injects under the 'avahi-limited' role.

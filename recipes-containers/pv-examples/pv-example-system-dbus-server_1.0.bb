...
IMAGE_BASENAME = "pv-example-system-dbus-server"
...
install_scripts() {
    ...
    install -m 0755 ${WORKDIR}/pv-dbus-server.py ${IMAGE_ROOTFS}${bindir}/pv-dbus-system-server
}

ROOTFS_POSTPROCESS_COMMAND += "install_scripts; "

PVR_APP_ADD_EXTRA_ARGS += "--config=Entrypoint=/usr/bin/pv-dbus-system-server"

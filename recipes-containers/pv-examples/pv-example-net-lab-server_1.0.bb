SUMMARY = "Example Network Server Container (lab pool)"
DESCRIPTION = "Same HTTP server as pv-example-net-server but attached to the 'lab' IPAM pool for cross-pool reachability tests"
LICENSE = "MIT"
LIC_FILES_CHKSUM = "file://${COMMON_LICENSE_DIR}/MIT;md5=0835ade698e0bcf8506ecda2f7b4f302"

inherit core-image container-pvrexport

IMAGE_BASENAME = "pv-example-net-lab-server"

SUMMARY = "Device configuration with TWO IPAM network pools"
DESCRIPTION = "A device.json pvrexport defining two network pools (internal + lab) for cross-pool connectivity tests"
LICENSE = "MIT"
...
SRC_URI = "file://device-ipam-2pools.json"
...
fakeroot do_create_pvrexport() {
    ...
    cp ${WORKDIR}/device-ipam-2pools.json device.json

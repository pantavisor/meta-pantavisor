...
PV_DOCKER_IMAGE_ENVS = 'TEST_PATH="/" INTERACTIVE="false" OVERWRITE="false" VERBOSE="false" NETSIM="false"'
PV_DOCKER_IMAGE_ENTRYPOINT_ARGS = '-c "/usr/bin/pvtest-run $TEST_PATH $INTERACTIVE $OVERWRITE $VERBOSE $NETSIM"'

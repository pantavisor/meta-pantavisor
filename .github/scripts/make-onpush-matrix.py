...
lines = [
    ...
    "      - '**'",
    "    paths-ignore:",
    "      # Pushes that only touch CI internals (workflows, generators,",
    "      # templates, badge helpers), bot-generated changelogs, or docs",
    "      # don't change what's built — don't start a build for them.",
    "      - '.github/**'",
    "      - 'CHANGELOG/**'",
    "      - 'docs/**'",
    "  pull_request:",

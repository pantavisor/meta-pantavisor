...
2. Parse the JSON and display a compact numbered table:
   ...
   Stable releases:
   #   Version     Machines
   1.  026         container-x86_64-scarthgap, imx8qxp-b0-mek-scarthgap, ...
   2.  025         container-x86_64-scarthgap, raspberrypi-armv8-scarthgap, ...
   3.  024         ...
   4.  02-test     ...

   Release candidates:
   #   Version     Machines
   5.  027-rc5     container-x86_64-scarthgap, ...
   6.  027-rc2     ...
   7.  027-rc1     ...
   8.  024-rc3     ...
   9.  024-rc2     ...
